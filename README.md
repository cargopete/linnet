...
Planned (Stage 2+): HealthKit reproductive categories, pregnancy mode
(Naegele's-rule EDD), perimenopause symptom-only tracking, inclusive onboarding,
and an *opt-in* zero-knowledge encrypted backup. See
